    ...
    <footer class="container footer bg-falcon pt-5">
        <div class="row align-items-center d-flex">
            ...
            <div class="col-auto order-3 order-md-2 mt-2 mt-md-0">
                <div class="row">
                    <div class="col-auto">
                        <a href="https://t.me/anonstjbot" target="_blank" class="text-900">Контакты</a>
                    </div>
                    <div class="col-auto">
                        <a href="https://t.me/anonstjbot" target="_blank" class="text-900">Реклама</a>
                    </div>
                    <div class="col-auto">
            ...
            <div class="col-auto col-end float-right gap-2 ms-auto text-center fs-2 order-2">
                <a href="https://t.me/anonstj/" target="_blank"><i class="fab fa-telegram text-500"></i></a>
                <a href="https://www.instagram.com/anonstj/" target="_blank"><i class="fab fa-instagram text-500"></i></a>
            </div>
        ...
        <div class="row g-0 justify-content-between fs--1 mt-4">
            <div class="col-12 col-sm-auto text-center order-2 order-md-1">
                <p class="text-600">
                    <span class="fw-bold">© Anons</span>, {{ \Carbon\Carbon::now()->year }}
                </p>
            </div>
